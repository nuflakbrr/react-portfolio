            ...
            <div className="lg:w-4/6 mx-auto">
              ...
              <div className="flex flex-col sm:flex-row mt-10">
                ...
                <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-800 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-justify sm:text-justify">
                  ...
                  <a href="https://github.com/nuflakbrr/music-player" target="_blank" rel="noreferrer" className="text-blue-600 inline-flex items-center hover:text-blue-400">
                    Source Code
                  </a>
                  <a href="https://nuflakbrr.github.io/music-player/" target="_blank" rel="noreferrer" className="text-blue-600 inline-flex items-center ml-4 hover:text-blue-400">
                    Webpage
                  </a>
                </div>
              </div>
