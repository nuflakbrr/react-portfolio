      ...
      <React.Fragment>
        <section className="text-gray-400 bg-gray-900 body-font">
          <div className="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
            <Fade>
              <img className="lg:w-1/5 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="Profile Image" src={Profile} />
            </Fade>
              ...
              <div className="w-full md:w-2/3 flex flex-col mb-16 items-center text-justify">
                ...
                <div className="flex justify-center">
                  ...
                  <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start items-center">
                    <a className="text-gray-400" href="https://github.com/nuflakbrr" target="_blank" rel="noreferrer">
                    ...
                    <a className="ml-3 text-gray-400" href="https://www.instagram.com/kbrnugroho/" target="_blank" rel="noreferrer">
                      <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                        <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
                        <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
                      </svg>
                    </a>
                    <a className="ml-3 text-gray-400" href="https://www.linkedin.com/public-profile/in/nuflakbrr" target="_blank" rel="noreferrer">
                      <svg fill="currentColor" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0" className="w-5 h-5" viewBox="0 0 24 24">
                        <path stroke="none" d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z"></path>
                        <circle cx="4" cy="4" r="2" stroke="none"></circle>
                      </svg>
                    </a>
                    <a className="ml-3 text-gray-400" href="mailto:naufalakbar378@gmail.com" target="_blank" rel="noreferrer">
